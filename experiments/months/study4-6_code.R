...
expt = as.numeric(readline(prompt="Which study do you want to analyze? (Enter 4, 5, or 6): "))
...
# get ranks
# (the warnings this generates can be ignored)
for (i in 1:nrow(df.words.filt)) {
